...
<div class="container py-2 px-4">
    <a href="https://www.manutd.com/" class="navbar-brand mb-0 h1">
      <img src="https://upload.wikimedia.org/wikipedia/id/thumb/c/cc/Chelsea_FC.svg/1200px-Chelsea_FC.svg.png" alt=""> Chelsea FC
    </a>
    <button
...
<div class="carousel-item active">
  <img src="https://media.vanityfair.com/photos/626acbdb6c174fa7992e18bd/master/pass/Chelsea-F.C.-Tout-Embed.jpg" class="d-block w-100" alt="...">
...
<div class="carousel-item">
  <img src="https://frontofficesports.com/wp-content/uploads/2023/03/FOS-23-3.28-Chelsea-FC.jpg" class="d-block w-100" alt="...">
  <div class="carousel-caption d-none d-md-block">
...
<div class="carousel-item">
  <img src="https://img.chelseafc.com/image/upload/f_auto,w_1440,c_fill,g_faces,q_90/editorial/match-reports/2022-23/Leeds%20home/fofana-celebs-leeds-h.jpg" class="d-block w-100" alt="...">
  <div class="carousel-caption d-none d-md-block">
...
<img src="https://cdn1-production-images-kly.akamaized.net/T-PS678csSy-CGxL4r0nLqovTKk=/1200x1200/smart/filters:quality(75):strip_icc():format(webp)/kly-media-production/medias/4298324/original/051827300_1674314674-AP23021505080610.jpg" class="card-img-top" alt="...">
<div class="card-body">
...
<div class="card" style="width: 18rem;">
<img src="https://i.guim.co.uk/img/media/eb6caf6db81be662905ee1230f1eddc6a9831624/0_206_5472_3283/master/5472.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=0f2236596712182911c4fef6b47c55e2" class="card-img-top" alt="...">
<div class="card-body">
<h5 class="card-title">Card title</h5>
<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
<a href="#" class="btn btn-primary">Go somewhere</a>
...
<div class="card" style="width: 18rem;">
<img src="https://pbs.twimg.com/profile_images/1724010627969024000/tcvPR3Qy_400x400.jpg" class="card-img-top" alt="...">
<div class="card-body">
<h5 class="card-title">Card title</h5>
<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
<a href="#" class="btn btn-primary">Go somewhere</a>
...
<img src="https://www.si.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1200/MTY4MDA3NDUyMjY5MjkwODgw/chelsea-fc-v-tottenham-hotspur-premier-league-5c85356d399f6a19a5000001jpg.jpg" class="card-img-top" alt="...">
<div class="card-body">
<h5 class="card-title">Card title</h5>
<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
<a href="#" class="btn btn-primary">Go somewhere</a>
