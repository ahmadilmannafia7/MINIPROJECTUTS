                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('name_item') is-invalid @enderror" id="name-item" name="name_item" placeholder="Input Product Code" value="{{ $item->name }}" required>
                                    @error('name_item')
