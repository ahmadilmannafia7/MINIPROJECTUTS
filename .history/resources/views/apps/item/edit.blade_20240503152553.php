                        ...
                        <div class="container">
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control @error('desc_item') is-invalid @enderror" id="desc-item" name="desc_item" placeholder="Input Product Code" style="height: 150px" required>{{ $item->desc }}</textarea>
                                    @error('desc_item')
