            ...
            <div class="row mb-0 mt-4 head-title">
                ...
                <div class="col-lg-3 col-xl-2">
                    <div class="d-grid gap-4">
                        <a href="{{ route('item.create') }}" class="btn btn-success">Add Product</a>
                    </div>
                </div>
            </div>
            <hr>
                    ...
                    <table class="table table-hover table-responsive" id="table-items">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" width="150px">Product Code</th>
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="price-item" value="{{ "$". number_format($item->price, 0, ".", ",") }}" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-3">
                                                                <div class="col-6">
